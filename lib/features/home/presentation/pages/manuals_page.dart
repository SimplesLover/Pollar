...
class ManualsPage extends StatelessWidget {
                ...
                children: [
                  ...
                  Expanded(
                    child: manuals.isEmpty
                        ? _buildEmptyState()
                        : _buildManualsList(context, manuals),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildManualsList(BuildContext context, List manuals) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return ManualListTile(
          ...
          onTap: () => _navigateToPdf(context, manual.pdfPath, manual.title),
        );
      },
    );
  }
  ...
  void _navigateToPdf(BuildContext context, String pdfPath, String title) {
    Navigator.push(
      context,
      MaterialPageRoute(
